...
@Service
public class SearchStopoverService implements ISearchStopoverService {
  private final ISearchTicketsStopoverDepart searchTicketsStopoverDepart;
  private final ISearchTicketsStopoverArrive searchTicketsStopoverArrive;
  private final ISetFlight setFlight;
  @Autowired
  public SearchStopoverService(
    ISearchTicketsStopoverDepart searchTicketsStopoverDepart,
    ISearchTicketsStopoverArrive searchTicketsStopoverArrive,
    ISetFlight setFlight)
  {
    ...
    List<FlightInfo> flights)
  {
    ...
    List<FlightCapacity> flightResults1 = searchTicketsStopoverDepart.searchTicketsDepart(
      DepartAirport,
    ...
    List<FlightCapacity> flightResults2 = searchTicketsStopoverArrive.searchTicketsArrive(
        ArriveAirport,
        departure_min_timestamp,
        departure_max_timestamp
    );
